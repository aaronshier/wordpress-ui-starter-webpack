<?php
    ...
    $args = array(
        ...
        'display_name'         => 'Babies and Pugs - Our Work Plugin Settings',
        ...
        'menu_title'           => __( 'Our Work', 'redux-framework-demo' ),
        'page_title'           => __( 'Our Work', 'redux-framework-demo' ),
        ...
        'admin_bar_icon'       => 'dashicons-images-alt',
        // Choose an icon for the admin bar menu
        'admin_bar_priority'   => 999,
        // Choose an priority for the admin bar menu
        'global_variable'      => 'bpow',
        ...
        'page_icon'            => 'dashicons-images-alt',
    ...
    if ( ! isset( $args['global_variable'] ) || $args['global_variable'] !== false ) {
        ...
        $args['intro_text'] = sprintf( __( '<p>Custom plugin for presenting the Babies and Pugs \'Our Work\' section.', 'redux-framework-demo' ), $v );
    } else {
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'All settings', 'redux-framework-demo' ),
        'id'         => 'media-media',
        'desc'       => __( '<strong>To use this plugin in your page simply add the shortcode to any widget, page, or post like so <span style="background: #eee; padding: 10px">[our_work_pictures]</span></strong>', 'redux-framework-demo' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'bpug_owork_title',
                ...
                'subtitle' => __( 'Choose the title for the Our Work section', 'redux-framework-demo' ),
                'desc'     => __( 'This will be displayed at the top of the section', 'redux-framework-demo' ),
                'default'  => 'Some of our work',
            ),
            array(
                'id'       => 'bpug_owork_title_color',
                'type'     => 'color',
                'title'    => __( 'Site Title Color', 'redux-framework-demo' ),
                'subtitle' => __( 'Pick a title color for the theme (default: #000).', 'redux-framework-demo' ),
                'default'  => '#000000',
            ...
            array(
                'id'       => 'bpug_owork_title_pos',
                'type'     => 'button_set',
                'title'    => __( 'Set Title Position', 'redux-framework-demo' ),
                'subtitle' => __( 'This sets the text-align css property', 'redux-framework-demo' ),
                //Must provide key => value pairs for radio options
                'options'  => array(
                    '1' => 'Left',
                    '2' => 'Center',
            ...
            array(
                'id'       => 'bpug_owork_1-alt',
                'type'     => 'text',
                'title'    => __( 'Image 1 Alt Tag (SEO)', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify an alt tag for the image', 'redux-framework-demo' ),
                'desc'     => __( 'Search engines use alt tags to decide the context of an image.', 'redux-framework-demo' ),
                'default'  => 'Los Angeles Newest Baby and Pet photography studio',
            ),
            ...
            array(
                'id'       => 'bpug_owork_2-alt',
                'type'     => 'text',
                'title'    => __( 'Image 2 Alt Tag (SEO)', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify an alt tag for the image', 'redux-framework-demo' ),
                'desc'     => __( 'Search engines use alt tags to decide the context of an image.', 'redux-framework-demo' ),
                'default'  => 'Los Angeles Newest Baby and Pet photography studio',
            ),
            ...
            array(
                'id'       => 'bpug_owork_3-alt',
                'type'     => 'text',
                'title'    => __( 'Image 3 Alt Tag (SEO)', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify an alt tag for the image', 'redux-framework-demo' ),
                'desc'     => __( 'Search engines use alt tags to decide the context of an image.', 'redux-framework-demo' ),
                'default'  => 'Los Angeles Newest Baby and Pet photography studio',
            ),
            ...
            array(
                'id'       => 'bpug_owork_4-alt',
                'type'     => 'text',
                'title'    => __( 'Image 4 Alt Tag (SEO)', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify an alt tag for the image', 'redux-framework-demo' ),
                'desc'     => __( 'Search engines use alt tags to decide the context of an image.', 'redux-framework-demo' ),
                'default'  => 'Los Angeles Newest Baby and Pet photography studio',
            ),
            ...
            array(
                'id'       => 'bpug_owork_5-alt',
                'type'     => 'text',
                'title'    => __( 'Image 5 Alt Tag (SEO)', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify an alt tag for the image', 'redux-framework-demo' ),
                'desc'     => __( 'Search engines use alt tags to decide the context of an image.', 'redux-framework-demo' ),
                'default'  => 'Los Angeles Newest Baby and Pet photography studio',
            ),
            ...
            array(
                'id'       => 'bpug_owork_6-alt',
                'type'     => 'text',
                'title'    => __( 'Image 6 Alt Tag (SEO)', 'redux-framework-demo' ),
                'subtitle' => __( 'Specify an alt tag for the image', 'redux-framework-demo' ),
                'desc'     => __( 'Search engines use alt tags to decide the context of an image.', 'redux-framework-demo' ),
                'default'  => 'Los Angeles Newest Baby and Pet photography studio',
            ),
